...
import DevicesContent from '../content/DevicesContent.react'
  ...
  render: function() {
    ...
    return (
      <div>
        ...
        {this.props.page == "devices" &&
          <div>
            <DevicesContent title={this.state.content.header.devices} content={this.state.content.devices} />
            <div className="xl-maw1280 xl-ma xl-px24">
              <Footer content={this.state.content.footer} />
            </div>
          </div>
        }
